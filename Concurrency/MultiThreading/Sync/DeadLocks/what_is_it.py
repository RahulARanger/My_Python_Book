...
For unregistered patient they have to first visit the office (for registration) and the counter ( for vaccination)
...
the locks office_safety and counter_safety doesn't allow patients to visit the office and counter respectively if it's occupied
...
"""
As you can see, this is just a victim of unsystematic approach
"""
