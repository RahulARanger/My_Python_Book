...
try:
    print(a._age)
    # ! this _ variable actually means a protected member but it does allow access and modification right outside the class
    # ? hence one shouldn't access tht directly
    a._age=21
except:
